    ...
    const vm = new Vue({
        ...
        methods: {
                ...
                getRandomMsg(dialog.details)
                    .forEach(content => {
                        this.msgChain = this.msgChain
                            .then(() => delay(700))
                            .then(() => this.sendMsg(content, AUTHOR.ishx));
                    });

                return dialog.nextishx
                    ? this.appendDialog(dialog.nextishx)
                    : this.msgChain.then(() => {
                        this.lastDialog = dialog;
                        this.isishxTyping = false;
                    });
            },
            ...
            getDialog(id) {
                ...
                const dialogs = this.dialogs.fromishx
            ...
            togglePrompt(toShow) {
                if (this.isishxTyping) {
                    // don't prompt if ishx is typing
                    return;
                }
            ...
            respond(response) {
                ...
                return this.say(response.content, response.nextishx);
            },
            ...
            ask(fromUser) {
                ...
                return this.say(content, fromUser.nextishx);
            },
